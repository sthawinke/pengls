...
```{r illustrFolds}
set.seed(5657)
randomFolds = makeFolds(nfolds = 5, dfTime, "random", "t")
blockedFolds = makeFolds(nfolds = 5, dfTime, "blocked", "t")
...
```{r cvgplsTimeCourse}
gplsFitCVtime = cv.gpls(data = dfTime, outVar = "a", xNames = grep(names(df), pattern = "b", value =TRUE),
glsSt = corStructTime, nfolds = 5, cvType = "random")
```
